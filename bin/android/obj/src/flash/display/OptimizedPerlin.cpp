...
{
HX_STACK_PUSH("OptimizedPerlin::new","flash/display/BitmapData.hx",847);
...
{
		HX_STACK_PUSH("OptimizedPerlin::seedOffset","flash/display/BitmapData.hx",993);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::octFreqPers","flash/display/BitmapData.hx",970);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("OptimizedPerlin::fill","flash/display/BitmapData.hx",856);
		HX_STACK_THIS(this);
							...
							while(((_g2 < octaves))){
								...
								struct _Function_7_1{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",919);
										{
											HX_STACK_LINE(919)
								...
								struct _Function_7_3{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",922);
										{
											HX_STACK_LINE(922)
								...
								struct _Function_7_5{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",925);
										{
											HX_STACK_LINE(925)
								...
								struct _Function_7_7{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",928);
										{
											HX_STACK_LINE(928)
								...
								struct _Function_7_9{
									inline static Float Block( Float &y1,Float &x1,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",931);
										{
											HX_STACK_LINE(931)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y1) );
										}
								...
								struct _Function_7_11{
									inline static Float Block( Float &y1,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",934);
										{
											HX_STACK_LINE(934)
											return (  (((hash < (int)8))) ? Float(x) : Float(y1) );
										}
								...
								struct _Function_7_13{
									inline static Float Block( Float &x1,Float &y,int &hash){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",937);
										{
											HX_STACK_LINE(937)
											return (  (((hash < (int)8))) ? Float(x1) : Float(y) );
										}
								...
								struct _Function_7_15{
									inline static Float Block( Float &y,int &hash,Float &x){
										HX_STACK_PUSH("*::closure","flash/display/BitmapData.hx",940);
										{
											HX_STACK_LINE(940)
											return (  (((hash < (int)8))) ? Float(x) : Float(y) );
										}
