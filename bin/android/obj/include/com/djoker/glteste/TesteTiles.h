...
#define INCLUDED_com_djoker_glteste_TesteTiles
...
HX_DECLARE_CLASS3(com,djoker,glteste,TesteTiles)
...
class HXCPP_CLASS_ATTRIBUTES  TesteTiles_obj : public ::com::engine::game::Screen_obj{
	public:
		typedef ::com::engine::game::Screen_obj super;
		typedef TesteTiles_obj OBJ_;
		TesteTiles_obj();
		Void __construct();

	public:
		static hx::ObjectPtr< TesteTiles_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("TesteTiles"); }
		...
		int scroll;
		::com::engine::math::Vector3 position;
...
#endif /* INCLUDED_com_djoker_glteste_TesteTiles */ 
