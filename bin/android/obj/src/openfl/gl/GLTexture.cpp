...
{
HX_STACK_PUSH("GLTexture::new","openfl/gl/GLTexture.hx",7);
{
	HX_STACK_LINE(7)
...
::String GLTexture_obj::getType( ){
	HX_STACK_PUSH("GLTexture::getType","openfl/gl/GLTexture.hx",14);
	HX_STACK_THIS(this);
	HX_STACK_LINE(14)
...
void GLTexture_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(GLTexture);
	super::__Mark(HX_MARK_ARG);
	HX_MARK_END_CLASS();
}

void GLTexture_obj::__Visit(HX_VISIT_PARAMS)
{
