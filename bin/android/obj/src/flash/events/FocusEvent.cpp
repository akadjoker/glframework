...
{
HX_STACK_PUSH("FocusEvent::new","flash/events/FocusEvent.hx",20);
...
::String FocusEvent_obj::toString( ){
	HX_STACK_PUSH("FocusEvent::toString","flash/events/FocusEvent.hx",38);
	HX_STACK_THIS(this);
	HX_STACK_LINE(38)
...
::flash::events::Event FocusEvent_obj::clone( ){
	HX_STACK_PUSH("FocusEvent::clone","flash/events/FocusEvent.hx",31);
	HX_STACK_THIS(this);
	HX_STACK_LINE(31)
	return ::flash::events::FocusEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->relatedObject,this->shiftKey,this->keyCode,null());
}
