...
{
HX_STACK_PUSH("ErrorEvent::new","flash/events/ErrorEvent.hx",12);
...
::String ErrorEvent_obj::toString( ){
	HX_STACK_PUSH("ErrorEvent::toString","flash/events/ErrorEvent.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
...
::flash::events::Event ErrorEvent_obj::clone( ){
	HX_STACK_PUSH("ErrorEvent::clone","flash/events/ErrorEvent.hx",20);
	HX_STACK_THIS(this);
	HX_STACK_LINE(20)
	return ::flash::events::ErrorEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->text,this->errorID);
}
