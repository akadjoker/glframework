...
{
HX_STACK_PUSH("MouseEvent::new","flash/events/MouseEvent.hx",47);
...
::flash::events::MouseEvent MouseEvent_obj::__createSimilar( ::String type,::flash::display::InteractiveObject related,::flash::display::InteractiveObject target){
	HX_STACK_PUSH("MouseEvent::__createSimilar","flash/events/MouseEvent.hx",98);
	HX_STACK_THIS(this);
	HX_STACK_ARG(type,"type");
	HX_STACK_ARG(related,"related");
	HX_STACK_ARG(target,"target");
	HX_STACK_LINE(100)
	::flash::events::MouseEvent mouseEvent = ::flash::events::MouseEvent_obj::__new(type,this->get_bubbles(),this->get_cancelable(),this->localX,this->localY,(  (((related == null()))) ? ::flash::display::InteractiveObject(this->relatedObject) : ::flash::display::InteractiveObject(related) ),this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);		HX_STACK_VAR(mouseEvent,"mouseEvent");
	HX_STACK_LINE(102)
...
{
		HX_STACK_PUSH("MouseEvent::updateAfterEvent","flash/events/MouseEvent.hx",79);
		HX_STACK_THIS(this);
	}
return null();
}
...
::String MouseEvent_obj::toString( ){
	HX_STACK_PUSH("MouseEvent::toString","flash/events/MouseEvent.hx",72);
	HX_STACK_THIS(this);
	HX_STACK_LINE(72)
...
::flash::events::Event MouseEvent_obj::clone( ){
	HX_STACK_PUSH("MouseEvent::clone","flash/events/MouseEvent.hx",65);
	HX_STACK_THIS(this);
	HX_STACK_LINE(65)
	return ::flash::events::MouseEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->clickCount);
}
...
::flash::events::MouseEvent MouseEvent_obj::__create( ::String type,Dynamic event,::flash::geom::Point local,::flash::display::InteractiveObject target){
	HX_STACK_PUSH("MouseEvent::__create","flash/events/MouseEvent.hx",86);
	HX_STACK_ARG(type,"type");
