...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::flash::Lib_obj::setPackage(HX_CSTRING("djoker"),HX_CSTRING("glframework"),HX_CSTRING("com.djoker.glframework"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",35);
			{
				...
				HX_STACK_LINE(54)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::com::djoker::glteste::Main >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(54)
					while(((_g < _g1->length))){
						HX_STACK_LINE(54)
				...
				if ((hasMain)){
					HX_STACK_LINE(65)
					::Reflect_obj::callMethod(hx::ClassOf< ::com::djoker::glteste::Main >(),::Reflect_obj::field(hx::ClassOf< ::com::djoker::glteste::Main >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(71)
		...
		HX_STACK_LINE(35)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)10000,(int)0,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(::flash::Lib_obj::ALLOW_SHADERS))) | int(::flash::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::flash::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("glframework by Luis Santos AKA DJOKER"),null(),null());
	}
return null();
}
