...
HX_STACK_PUSH("DefaultAssetLibrary::new","DefaultAssetLibrary.hx",33);
{
	...
	try{
		...
		if (((bytes != null()))){
			...
			HX_STACK_LINE(138)
			::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),140,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("new")));
		}
	}
	catch(Dynamic __e){
		{
			...
			Dynamic e = __e;{
				HX_STACK_LINE(144)
				::haxe::Log_obj::trace(HX_CSTRING("Warning: Could not load asset manifest"),hx::SourceInfo(HX_CSTRING("DefaultAssetLibrary.hx"),146,HX_CSTRING("DefaultAssetLibrary"),HX_CSTRING("new")));
			}
		}
	}
}
...
{
		HX_STACK_PUSH("DefaultAssetLibrary::loadSound","DefaultAssetLibrary.hx",507);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
...
{
		HX_STACK_PUSH("DefaultAssetLibrary::loadMusic","DefaultAssetLibrary.hx",478);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(478)
...
{
		HX_STACK_PUSH("DefaultAssetLibrary::loadFont","DefaultAssetLibrary.hx",449);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(449)
...
{
		HX_STACK_PUSH("DefaultAssetLibrary::loadBytes","DefaultAssetLibrary.hx",412);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(412)
...
{
		HX_STACK_PUSH("DefaultAssetLibrary::loadBitmapData","DefaultAssetLibrary.hx",379);
		HX_STACK_THIS(this);
		HX_STACK_ARG(id,"id");
		HX_STACK_ARG(handler,"handler");
		HX_STACK_LINE(379)
...
bool DefaultAssetLibrary_obj::isLocal( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("DefaultAssetLibrary::isLocal","DefaultAssetLibrary.hx",362);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
...
::flash::media::Sound DefaultAssetLibrary_obj::getSound( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getSound","DefaultAssetLibrary.hx",339);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(339)
...
::String DefaultAssetLibrary_obj::getPath( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getPath","DefaultAssetLibrary.hx",324);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(324)
...
::flash::media::Sound DefaultAssetLibrary_obj::getMusic( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getMusic","DefaultAssetLibrary.hx",301);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(301)
...
::flash::text::Font DefaultAssetLibrary_obj::getFont( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getFont","DefaultAssetLibrary.hx",282);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(282)
...
::flash::utils::ByteArray DefaultAssetLibrary_obj::getBytes( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getBytes","DefaultAssetLibrary.hx",233);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(233)
...
::flash::display::BitmapData DefaultAssetLibrary_obj::getBitmapData( ::String id){
	HX_STACK_PUSH("DefaultAssetLibrary::getBitmapData","DefaultAssetLibrary.hx",210);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_LINE(210)
...
bool DefaultAssetLibrary_obj::exists( ::String id,::openfl::AssetType type){
	HX_STACK_PUSH("DefaultAssetLibrary::exists","DefaultAssetLibrary.hx",155);
	HX_STACK_THIS(this);
	HX_STACK_ARG(id,"id");
	HX_STACK_ARG(type,"type");
	HX_STACK_LINE(157)
