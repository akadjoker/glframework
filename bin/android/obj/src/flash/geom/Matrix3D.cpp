...
{
HX_STACK_PUSH("Matrix3D::new","flash/geom/Matrix3D.hx",15);
{
	HX_STACK_LINE(15)
...
::flash::geom::Vector3D Matrix3D_obj::set_position( ::flash::geom::Vector3D value){
	HX_STACK_PUSH("Matrix3D::set_position","flash/geom/Matrix3D.hx",657);
	HX_STACK_THIS(this);
...
::flash::geom::Vector3D Matrix3D_obj::get_position( ){
	HX_STACK_PUSH("Matrix3D::get_position","flash/geom/Matrix3D.hx",650);
	HX_STACK_THIS(this);
	HX_STACK_LINE(650)
...
Float Matrix3D_obj::get_determinant( ){
	HX_STACK_PUSH("Matrix3D::get_determinant","flash/geom/Matrix3D.hx",638);
	HX_STACK_THIS(this);
	HX_STACK_LINE(638)
...
{
		HX_STACK_PUSH("Matrix3D::transpose","flash/geom/Matrix3D.hx",612);
		HX_STACK_THIS(this);
		HX_STACK_LINE(614)
...
{
		HX_STACK_PUSH("Matrix3D::transformVectors","flash/geom/Matrix3D.hx",592);
		HX_STACK_THIS(this);
...
::flash::geom::Vector3D Matrix3D_obj::transformVector( ::flash::geom::Vector3D v){
	HX_STACK_PUSH("Matrix3D::transformVector","flash/geom/Matrix3D.hx",579);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(581)
...
bool Matrix3D_obj::recompose( Array< ::Dynamic > components){
	HX_STACK_PUSH("Matrix3D::recompose","flash/geom/Matrix3D.hx",556);
	HX_STACK_THIS(this);
	HX_STACK_ARG(components,"components");
	HX_STACK_LINE(558)
	if (((bool((bool((bool((components->__Field(HX_CSTRING("length"),true) < (int)3)) || bool((components->__get((int)2).StaticCast< ::flash::geom::Vector3D >()->x == (int)0)))) || bool((components->__get((int)2).StaticCast< ::flash::geom::Vector3D >()->y == (int)0)))) || bool((components->__get((int)2).StaticCast< ::flash::geom::Vector3D >()->z == (int)0))))){
		HX_STACK_LINE(558)
		return false;
	}
	HX_STACK_LINE(560)
...
{
		HX_STACK_PUSH("Matrix3D::prependTranslation","flash/geom/Matrix3D.hx",547);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(z,"z");
...
{
		HX_STACK_PUSH("Matrix3D::prependScale","flash/geom/Matrix3D.hx",540);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xScale,"xScale");
		HX_STACK_ARG(yScale,"yScale");
		HX_STACK_ARG(zScale,"zScale");
		HX_STACK_LINE(540)
		this->prepend(::flash::geom::Matrix3D_obj::__new(Array_obj< Float >::__new().Add(xScale).Add(0.0).Add(0.0).Add(0.0).Add(0.0).Add(yScale).Add(0.0).Add(0.0).Add(0.0).Add(0.0).Add(zScale).Add(0.0).Add(0.0).Add(0.0).Add(0.0).Add(1.0)));
	}
return null();
}
...
{
		HX_STACK_PUSH("Matrix3D::prependRotation","flash/geom/Matrix3D.hx",524);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Matrix3D::prepend","flash/geom/Matrix3D.hx",490);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Matrix3D::pointAt","flash/geom/Matrix3D.hx",423);
		HX_STACK_THIS(this);
		...
		if (((at == null()))){
			HX_STACK_LINE(425)
			at = ::flash::geom::Vector3D_obj::__new((int)0,(int)0,(int)-1,null());
		}
		HX_STACK_LINE(431)
		if (((up == null()))){
			HX_STACK_LINE(431)
			up = ::flash::geom::Vector3D_obj::__new((int)0,(int)-1,(int)0,null());
		}
		HX_STACK_LINE(437)
		...
		HX_STACK_LINE(447)
		vup = ::flash::geom::Vector3D_obj::__new((vup->x - dir2->x),(vup->y - dir2->y),(vup->z - dir2->z),null());
		HX_STACK_LINE(449)
		if (((::Math_obj::sqrt((((vup->x * vup->x) + (vup->y * vup->y)) + (vup->z * vup->z))) > (int)0))){
			...
			if (((dir->x != (int)0))){
				HX_STACK_LINE(455)
				vup = ::flash::geom::Vector3D_obj::__new(-(dir->y),dir->x,(int)0,null());
			}
			else{
				HX_STACK_LINE(459)
				vup = ::flash::geom::Vector3D_obj::__new((int)1,(int)0,(int)0,null());
			}
		}
		HX_STACK_LINE(467)
		right = ::flash::geom::Vector3D_obj::__new(((vup->y * dir->z) - (vup->z * dir->y)),((vup->z * dir->x) - (vup->x * dir->z)),((vup->x * dir->y) - (vup->y * dir->x)),(int)1);
		HX_STACK_LINE(468)
		{
			HX_STACK_LINE(468)
...
bool Matrix3D_obj::invert( ){
	HX_STACK_PUSH("Matrix3D::invert","flash/geom/Matrix3D.hx",386);
	HX_STACK_THIS(this);
	HX_STACK_LINE(388)
...
{
		HX_STACK_PUSH("Matrix3D::interpolateTo","flash/geom/Matrix3D.hx",375);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Matrix3D::identity","flash/geom/Matrix3D.hx",338);
		HX_STACK_THIS(this);
		HX_STACK_LINE(340)
...
::flash::geom::Vector3D Matrix3D_obj::deltaTransformVector( ::flash::geom::Vector3D v){
	HX_STACK_PUSH("Matrix3D::deltaTransformVector","flash/geom/Matrix3D.hx",293);
	HX_STACK_THIS(this);
	HX_STACK_ARG(v,"v");
	HX_STACK_LINE(295)
	Float x = v->x;		HX_STACK_VAR(x,"x");
...
Array< ::Dynamic > Matrix3D_obj::decompose( ){
	HX_STACK_PUSH("Matrix3D::decompose","flash/geom/Matrix3D.hx",235);
	HX_STACK_THIS(this);
	HX_STACK_LINE(237)
...
{
		HX_STACK_PUSH("Matrix3D::copyToMatrix3D","flash/geom/Matrix3D.hx",180);
		HX_STACK_THIS(this);
...
{
		HX_STACK_PUSH("Matrix3D::copyRowTo","flash/geom/Matrix3D.hx",163);
		HX_STACK_THIS(this);
		...
		if (((row > (int)3))){
			HX_STACK_LINE(165)
			hx::Throw (((HX_CSTRING("Row ") + row) + HX_CSTRING(" out of bounds (3)")));
		}
		HX_STACK_LINE(171)
...
{
		HX_STACK_PUSH("Matrix3D::copyRowFrom","flash/geom/Matrix3D.hx",146);
		HX_STACK_THIS(this);
		HX_STACK_ARG(row,"row");
		HX_STACK_ARG(vector3D,"vector3D");
		HX_STACK_LINE(148)
...
{
		HX_STACK_PUSH("Matrix3D::copyFrom","flash/geom/Matrix3D.hx",135);
		HX_STACK_THIS(this);
		HX_STACK_ARG(other,"other");
		HX_STACK_LINE(137)
		int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
{
		HX_STACK_PUSH("Matrix3D::copyColumnTo","flash/geom/Matrix3D.hx",119);
		HX_STACK_THIS(this);
		...
		if (((column > (int)3))){
			HX_STACK_LINE(121)
			hx::Throw (((HX_CSTRING("Column ") + column) + HX_CSTRING(" out of bounds (3)")));
		}
		HX_STACK_LINE(127)
...
{
		HX_STACK_PUSH("Matrix3D::copyColumnFrom","flash/geom/Matrix3D.hx",103);
		HX_STACK_THIS(this);
		HX_STACK_ARG(column,"column");
		HX_STACK_ARG(vector3D,"vector3D");
		HX_STACK_LINE(105)
...
::flash::geom::Matrix3D Matrix3D_obj::clone( ){
	HX_STACK_PUSH("Matrix3D::clone","flash/geom/Matrix3D.hx",96);
	HX_STACK_THIS(this);
	HX_STACK_LINE(96)
	return ::flash::geom::Matrix3D_obj::__new(::flash::_Vector::Vector_Impl__obj::copy(this->rawData));
}
...
{
		HX_STACK_PUSH("Matrix3D::appendTranslation","flash/geom/Matrix3D.hx",87);
		HX_STACK_THIS(this);
		HX_STACK_ARG(x,"x");
		HX_STACK_ARG(y,"y");
		HX_STACK_ARG(z,"z");
...
{
		HX_STACK_PUSH("Matrix3D::appendScale","flash/geom/Matrix3D.hx",80);
		HX_STACK_THIS(this);
		HX_STACK_ARG(xScale,"xScale");
		HX_STACK_ARG(yScale,"yScale");
		HX_STACK_ARG(zScale,"zScale");
...
{
		HX_STACK_PUSH("Matrix3D::appendRotation","flash/geom/Matrix3D.hx",64);
		HX_STACK_THIS(this);
		HX_STACK_ARG(degrees,"degrees");
		HX_STACK_ARG(axis,"axis");
		HX_STACK_ARG(pivotPoint,"pivotPoint");
...
{
		HX_STACK_PUSH("Matrix3D::append","flash/geom/Matrix3D.hx",30);
		HX_STACK_THIS(this);
...
Float rotation = __o_rotation.Default(0);
	HX_STACK_PUSH("Matrix3D::create2D","flash/geom/Matrix3D.hx",191);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
...
::flash::geom::Matrix3D Matrix3D_obj::createABCD( Float a,Float b,Float c,Float d,Float tx,Float ty){
	HX_STACK_PUSH("Matrix3D::createABCD","flash/geom/Matrix3D.hx",207);
	HX_STACK_ARG(a,"a");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
	HX_STACK_ARG(d,"d");
...
::flash::geom::Matrix3D Matrix3D_obj::createOrtho( Float x0,Float x1,Float y0,Float y1,Float zNear,Float zFar){
	HX_STACK_PUSH("Matrix3D::createOrtho","flash/geom/Matrix3D.hx",219);
	HX_STACK_ARG(x0,"x0");
	HX_STACK_ARG(x1,"x1");
	HX_STACK_ARG(y0,"y0");
	HX_STACK_ARG(y1,"y1");
...
::flash::geom::Matrix3D Matrix3D_obj::getAxisRotation( Float x,Float y,Float z,Float degrees){
	HX_STACK_PUSH("Matrix3D::getAxisRotation","flash/geom/Matrix3D.hx",306);
	HX_STACK_ARG(x,"x");
	HX_STACK_ARG(y,"y");
	HX_STACK_ARG(z,"z");
	HX_STACK_ARG(degrees,"degrees");
...
::flash::geom::Matrix3D Matrix3D_obj::interpolate( ::flash::geom::Matrix3D thisMat,::flash::geom::Matrix3D toMat,Float percent){
	HX_STACK_PUSH("Matrix3D::interpolate","flash/geom/Matrix3D.hx",360);
