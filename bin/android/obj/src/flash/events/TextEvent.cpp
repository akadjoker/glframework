...
{
HX_STACK_PUSH("TextEvent::new","flash/events/TextEvent.hx",13);
...
::String TextEvent_obj::toString( ){
	HX_STACK_PUSH("TextEvent::toString","flash/events/TextEvent.hx",29);
	HX_STACK_THIS(this);
	HX_STACK_LINE(29)
...
::flash::events::Event TextEvent_obj::clone( ){
	HX_STACK_PUSH("TextEvent::clone","flash/events/TextEvent.hx",22);
	HX_STACK_THIS(this);
	HX_STACK_LINE(22)
	return ::flash::events::TextEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->text);
}
