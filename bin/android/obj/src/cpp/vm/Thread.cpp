...
{
HX_STACK_PUSH("Thread::new","C:\\HaxeToolkit\\haxe/std/cpp/vm/Thread.hx",30);
{
	HX_STACK_LINE(30)
	this->handle = h;
}
...
{
		HX_STACK_PUSH("Thread::sendMessage","C:\\HaxeToolkit\\haxe/std/cpp/vm/Thread.hx",37);
		HX_STACK_THIS(this);
...
::cpp::vm::Thread Thread_obj::current( ){
	HX_STACK_PUSH("Thread::current","C:\\HaxeToolkit\\haxe/std/cpp/vm/Thread.hx",45);
	HX_STACK_LINE(45)
...
::cpp::vm::Thread Thread_obj::create( Dynamic callb){
	HX_STACK_PUSH("Thread::create","C:\\HaxeToolkit\\haxe/std/cpp/vm/Thread.hx",52);
...
Dynamic Thread_obj::readMessage( bool block){
	HX_STACK_PUSH("Thread::readMessage","C:\\HaxeToolkit\\haxe/std/cpp/vm/Thread.hx",61);
