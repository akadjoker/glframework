...
{
HX_STACK_PUSH("Mutex::new","C:\\HaxeToolkit\\haxe/std/cpp/vm/Mutex.hx",27);
{
	HX_STACK_LINE(27)
...
{
		HX_STACK_PUSH("Mutex::release","C:\\HaxeToolkit\\haxe/std/cpp/vm/Mutex.hx",36);
		HX_STACK_THIS(this);
		HX_STACK_LINE(36)
...
{
		HX_STACK_PUSH("Mutex::acquire","C:\\HaxeToolkit\\haxe/std/cpp/vm/Mutex.hx",30);
		HX_STACK_THIS(this);
		HX_STACK_LINE(30)
