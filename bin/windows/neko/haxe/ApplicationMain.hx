...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (com.djoker.glteste.Main)) {
...
@:keep class DocumentClass extends com.djoker.glteste.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "glframework by Luis Santos AKA DJOKER", null, { width: 800, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.djoker.glteste.Main, []);
			}
