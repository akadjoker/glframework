...
{
HX_STACK_PUSH("KeyboardEvent::new","flash/events/KeyboardEvent.hx",19);
...
::String KeyboardEvent_obj::toString( ){
	HX_STACK_PUSH("KeyboardEvent::toString","flash/events/KeyboardEvent.hx",43);
	HX_STACK_THIS(this);
	HX_STACK_LINE(43)
...
::flash::events::Event KeyboardEvent_obj::clone( ){
	HX_STACK_PUSH("KeyboardEvent::clone","flash/events/KeyboardEvent.hx",36);
	HX_STACK_THIS(this);
	HX_STACK_LINE(36)
	return ::flash::events::KeyboardEvent_obj::__new(this->get_type(),this->get_bubbles(),this->get_cancelable(),this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
}
