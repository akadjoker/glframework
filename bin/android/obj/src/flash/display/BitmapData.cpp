				...
				HX_STACK_LINE(353)
				{
					...
					while(((_g1 < sw))){
						...
						struct _Function_5_1{
							inline static int Block( int &b,Array< int > &redArray,int &g,Array< int > &blueArray,int &r,Array< int > &greenArray){
						...
						HX_STACK_LINE(361)
						color = _Function_5_1::Block(b,redArray,g,blueArray,r,greenArray);
						HX_STACK_LINE(366)
						::flash::Memory_obj::setI32(position,color);
					}
				}
