...
{
HX_STACK_PUSH("ColorTransform::new","flash/geom/ColorTransform.hx",18);
...
int ColorTransform_obj::set_color( int value){
	HX_STACK_PUSH("ColorTransform::set_color","flash/geom/ColorTransform.hx",56);
	HX_STACK_THIS(this);
...
int ColorTransform_obj::get_color( ){
	HX_STACK_PUSH("ColorTransform::get_color","flash/geom/ColorTransform.hx",49);
	HX_STACK_THIS(this);
	HX_STACK_LINE(49)
...
{
		HX_STACK_PUSH("ColorTransform::concat","flash/geom/ColorTransform.hx",32);
		HX_STACK_THIS(this);
