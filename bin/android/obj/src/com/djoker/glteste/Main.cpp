...
{
HX_STACK_PUSH("Main::new","com/djoker/glteste/Main.hx",43);
{
	HX_STACK_LINE(43)
	super::__construct();
}
...
Void Main_obj::begin( ){
{
		HX_STACK_PUSH("Main::begin","com/djoker/glteste/Main.hx",51);
		HX_STACK_THIS(this);
		HX_STACK_LINE(51)
		this->setScreen(::com::djoker::glteste::TesteTiles_obj::__new());
	}
return null();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.djoker.glteste.Main"), hx::TCanCast< Main_obj> ,sStaticFields,sMemberFields,
