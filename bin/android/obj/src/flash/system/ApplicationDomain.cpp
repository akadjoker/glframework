...
{
HX_STACK_PUSH("ApplicationDomain::new","flash/system/ApplicationDomain.hx",12);
{
	HX_STACK_LINE(12)
...
bool ApplicationDomain_obj::hasDefinition( ::String name){
	HX_STACK_PUSH("ApplicationDomain::hasDefinition","flash/system/ApplicationDomain.hx",34);
	HX_STACK_THIS(this);
...
Dynamic ApplicationDomain_obj::getDefinition( ::String name){
	HX_STACK_PUSH("ApplicationDomain::getDefinition","flash/system/ApplicationDomain.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_ARG(name,"name");
	HX_STACK_LINE(27)
