...
::String CallStack_obj::toString( Array< ::Dynamic > stack){
	HX_STACK_PUSH("CallStack::toString","C:\\HaxeToolkit\\haxe/std/haxe/CallStack.hx",128);
...
{
		HX_STACK_PUSH("CallStack::itemToString","C:\\HaxeToolkit\\haxe/std/haxe/CallStack.hx",137);
		HX_STACK_ARG(b,"b");
		HX_STACK_ARG(s,"s");
		HX_STACK_LINE(137)
		{
