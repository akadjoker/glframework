...
{
HX_STACK_PUSH("Error::new","flash/errors/Error.hx",12);
...
::String Error_obj::toString( ){
	HX_STACK_PUSH("Error::toString","flash/errors/Error.hx",27);
	HX_STACK_THIS(this);
	HX_STACK_LINE(27)
	return this->message;
}
...
::String Error_obj::getStackTrace( ){
	HX_STACK_PUSH("Error::getStackTrace","flash/errors/Error.hx",20);
	HX_STACK_THIS(this);
	HX_STACK_LINE(20)
	return HX_CSTRING("");
}
