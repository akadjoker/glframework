...
Void Stage_obj::__setActive( bool value){
{
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				HX_STACK_LINE(1012)
				if (((bool((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() != null())) && bool(focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >()->get_needsSoftKeyboard())))){

					HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_4_1,Array< ::Dynamic >,focus,Array< ::Dynamic >,_g)
					Void run(){
						HX_STACK_PUSH("*::_Function_4_1","flash/display/Stage.hx",1014);
						{
							HX_STACK_LINE(1014)
...
{
		HX_STACK_PUSH("Stage::dummyTrace","flash/display/Stage.hx",312);
		HX_STACK_THIS(this);
		HX_STACK_LINE(312)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),312,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
