	...
	HX_STACK_ARG(soundTransform,"soundTransform");
{
		...
		if ((this->__dynamicSound)){
			...
			if (((request->data->length > (int)0))){
				HX_STACK_LINE(184)
				this->__handle = ::flash::media::Sound_obj::lime_sound_channel_create_dynamic(request->data,soundTransform);
			}
			HX_STACK_LINE(190)
	...
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic");
{
		...
		HX_STACK_LINE(116)
		this->__handle = ::flash::media::Sound_obj::lime_sound_from_data(bytes,length,forcePlayAsMusic);
		HX_STACK_LINE(118)
		if (((this->__handle == null()))){
			HX_STACK_LINE(118)
	...
	HX_STACK_ARG(forcePlayAsMusic,"forcePlayAsMusic");
{
		...
		this->bytesTotal = (int)0;
		HX_STACK_LINE(92)
		this->__handle = ::flash::media::Sound_obj::lime_sound_from_file(stream->url,forcePlayAsMusic);
		HX_STACK_LINE(94)
		if (((this->__handle == null()))){
			HX_STACK_LINE(94)
